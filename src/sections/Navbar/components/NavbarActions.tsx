  ...
  return (
    <div className="items-center caret-transparent gap-x-3 flex min-h-[auto] min-w-[auto] outline-[3px] gap-y-3 no-underline w-max">
      <div className="caret-transparent hidden min-h-0 min-w-0 outline-[3px] no-underline md:block md:min-h-[auto] md:min-w-[auto]">
        <Link
          to="/register"
          className="content-center items-center bg-[#ff6a00] hover:bg-[#e05e00] shadow-[rgba(255,106,0,0.3)_0px_2px_8px_0px] box-border caret-transparent text-zinc-50 gap-x-2 grid justify-center outline-[3px] relative gap-y-2 no-underline text-nowrap overflow-hidden px-4 py-2 rounded-xl transition-colors"
        >
