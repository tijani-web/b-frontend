export const FooterRiskDisclosure = () => {
  return (
    <div className="caret-transparent gap-x-16 flex flex-col justify-between outline-[3px] gap-y-16 no-underline mt-16 mx-auto px-2 md:gap-x-[normal] md:flex-row md:gap-y-[normal] md:px-20">
      <p className="caret-transparent text-slate-300 text-[13px] leading-5 min-h-[auto] min-w-[auto] outline-[3px] no-underline w-full md:w-auto">
        ...
        greater than your initial investment.For trading security futures, read
        the Security Futures Risk Disclosure Statement. Structured products and
        fixed income products such as bonds are complex products that are more
        risky and are not suitable for all investors. Before trading, please
