...
export const HeroCta = (props: HeroCtaProps) => {
  return (
    <div
      className={`caret-transparent outline-[3px] no-underline w-max ${props.containerVariant}`}
    >
      <a
        href="https://app.BlofinPrime.com/markets"
        className={`content-center items-center bg-[#ff6a00] shadow-[rgba(113,50,245,0.2)_0px_2px_5px_0px,rgba(255,255,255,0.08)_0px_2px_3px_0px_inset] box-border caret-transparent text-zinc-50 gap-x-2 grid justify-center outline-[3px] relative gap-y-2 no-underline text-nowrap overflow-hidden px-3 py-2 rounded-xl ${props.linkVariant}`}
      >
