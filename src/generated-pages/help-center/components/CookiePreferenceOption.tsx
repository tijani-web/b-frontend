export type CookiePreferenceOptionProps = {
...
export const CookiePreferenceOption = (props: CookiePreferenceOptionProps) => {
  return (
    <div
    ...
    >
      <label className="items-center box-border caret-transparent inline-flex outline-[3px] relative no-underline pl-5 md:pl-10">
        <input
          type="checkbox"
          className={`bg-transparent box-border caret-transparent block text-[13.3333px] leading-[normal] outline-[3px] absolute text-start no-underline overflow-visible mr-2.5 p-0 left-0 font-arial md:left-2.5 ${props.checkboxVariant}`}
        />
